            ...
            <div className="max-w-1366 mx-auto">
                ...
                <div className="text-center pb-10 md:pb-12 border-b border-bdr-clr dark:border-bdr-clr-drk">
                    <Link to="/" className="inline-block mb-4">
                        <img src={logo} alt="Pavanity Global" className='dark:hidden w-[150px] sm:w-[200px] mx-auto'/>
                        <img src={logoLight} alt="Pavanity Global" className='dark:block hidden w-[150px] sm:w-[200px] mx-auto'/>
                    </Link>
                ...
                <div className="py-8 md:py-10">
                    <div className="flex flex-wrap items-center justify-center gap-x-6 lg:gap-x-8 gap-y-3">
                        {footerQuickLinks.map((link: LinkData, index: number) => (
                            ...
                            >
                                <span className="text-underline-primary">{link.name}</span>
                            </Link>
                        ))}
                    </div>
                </div>
