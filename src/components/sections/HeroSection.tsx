          ...
          <div className="flex flex-col items-center justify-center text-center py-20 sm:py-28 md:py-36 lg:py-44 px-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 mt-10 md:mt-12">
              {heroContent.trustIndicators.map((indicator, index) => (
                <span key={index} className="inline-flex items-center px-4 py-2 text-sm md:text-base text-title dark:text-white border border-title dark:border-white border-opacity-20 dark:border-opacity-20 rounded">
                  {indicator}
                </span>
              ))}
            </div>
